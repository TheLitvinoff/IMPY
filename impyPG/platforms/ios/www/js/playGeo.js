var playGeoState = {
	...
	checkClothesPosition: function() {
		if (this.clothes.countLiving() > 0) {
			for (var i = 0; i < this.clothes.countLiving(); i++) {
				var clothesLongitude = this.positions[i].clothesLon;
				var clothesLatitude = this.positions[i].clothesLat;
